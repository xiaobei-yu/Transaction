...
<div class="main">
	...
	<form id="form1" name="form1" method="post" action="" onsubmit="return checkit();">
		...
		<font color="red"></font>
			...
			<tbody>
				...
				<tr>
					...
					<td><input name="providerName" id="providerName" class="text" type="text"> <font color="red">*</font></td>

				</tr>
			<tr>
					<td class="field">供应商描述：</td>
					<td><textarea name="providerDescribe" id="textarea" cols="45" rows="5"></textarea></td>
				</tr>
				<tr>
					<td class="field">供应商联系：</td>

					<td><input name="providerContacts" class="text" type="text"></td>
				</tr>
				<tr>
					<td class="field">供应商电话：</td>
					<td><input name="providerTel" class="text" type="text"></td>
				</tr>
				
				<tr>
					<td class="field">供应商地址：</td>
					<td><input name="providerLoc" class="text" type="text"></td>
				</tr>
			</tbody></table>
		</div>
		...
		<div class="buttons">
			...
			<input name="button" id="button" value="删除" class="input-button" type="button">
		</div>
	</form>
</div>
</body>
